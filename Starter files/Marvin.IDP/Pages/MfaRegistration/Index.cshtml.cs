...
namespace Marvin.IDP.Pages.MfaRegistration
{
    ...
    public class IndexModel : PageModel
    {
        ...
        private readonly char[] chars = "ABCDEFGHIJKLMNOPRSTUVWXYZ".ToCharArray();

        public ViewModel View { get; set; }

        [BindProperty]
        public InputModel Input { get; set; } // This is bound to the view, so it contains info we can use on Post method
